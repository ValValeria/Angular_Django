...
class ProductAdmin(admin.ModelAdmin):
    ...
    def ID(self, obj):
        return format_html('<a href={} class="btn-link">{}</a>', "/admin/app/product/{}/change/".format(obj.id),
                           obj.id);
...
class CommentAdmin(admin.ModelAdmin):
    ...
    def ID(self, obj):
        return format_html('<a href={} class="btn-link">{}</a>', "/admin/app/comment/{}/change/".format(obj.id),
                           obj.id);
